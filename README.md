...
- 📚 [Cool Engines](https://github.com/JohnClarking/CoolEngines) - List of open source graphic & game engines.
- 📚 [Fantasy Consoles](https://github.com/paladin-t/fantasy) - List of available fantasy consoles/computers.
...
### Popular
- 🎉 [Godot](https://github.com/godotengine/godot) 🔥 - Feature-packed, open source engine. Excellent! [[Awesome](https://github.com/godotengine/awesome-godot) | [Website](https://godotengine.org)]
- 💸 [Unity](https://unity.com) - Biggest name in game engines, industry standard. [[Awesome](https://github.com/RyanNielson/awesome-unity)]
- 💸 [Unreal Engine](https://www.unrealengine.com) - AAA quality, insane feature set, photoreal visuals. [[Awesome](https://github.com/insthync/awesome-ue4)]

### AAA
- 🎉 [Amazon Lumberyard](https://github.com/aws/lumberyard) - AAA engine integrated with _AWS_ and _Twitch_. Forked from _CRYENGINE_.
...
- 💸 [NeoAxis](https://github.com/NeoAxis/NeoAxisEngine) - Versatile real-time platform for making games and apps.
...
- 💸 [PlayCanvas](https://playcanvas.com) - Popular (_Flappy Bird_) WebGL game engine. [[Awesome](https://github.com/playcanvas/awesome-playcanvas) | [GitHub](https://github.com/playcanvas/engine)]
...
- 🎉 [Adventure Game Studio](https://github.com/adventuregamestudio/ags) - Open source engine for point-and-click adventure games. [[Website](https://www.adventuregamestudio.co.uk/)]
...
- Awesome Collections
    ...
    - 📚 [Awesome Graphics Libraries](https://github.com/jslee02/awesome-graphics-libraries) - Curated list of 3D graphics libraries and resources.
- Blog Articles
...
- Graphics API: DirectX
    - 🌎 [DirectX](https://learn.microsoft.com/en-us/windows/win32/directx) - _Microsoft_ API used to create 2D/3D games and apps. [[Blog](https://devblogs.microsoft.com/directx/) | [Samples](https://github.com/microsoft/DirectX-Graphics-Samples)]
...
### Game Development
- Awesome Collections
    - 📚 [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) - Collection of free resources for making games.
...
- 📚 [Games of Coding](https://github.com/michelpereira/awesome-games-of-coding) - Games that teach you a programming language.
- 🌎 [Geeks for Geeks](https://www.geeksforgeeks.org) - Tutorials, articles, courses, coding competitions, jobs and more.
- 📚 [Learn to Program](https://github.com/karlhorky/learn-to-program) - Educational resources to learn to program.
...
### C
- 📚 [Awesome C](https://github.com/oz123/awesome-c) - List of awesome C frameworks, libraries, resources and other shiny things.
...
- C: Graphics - 3D
    ...
    - 🎉 [wgpu-native](https://github.com/gfx-rs/wgpu-native) - Native WebGPU implementation based on _wgpu-core_.
- C: Gui
...
- C: Physics
    - 🎉 [Chipmunk](https://github.com/slembcke/Chipmunk2D) - Fast, lightweight 2D game physics library.
- C: Scripting
...
### C++
- 📚 [Awesome C++](https://github.com/fffaraz/awesome-cpp) - List of awesome C++ frameworks, libraries, and resources.
- 📚 [Awesome C++ Game Dev](https://github.com/Caerind/AwesomeCppGameDev) - List of awesome C++ things for Game Development.
...
- C++: Fonts
    ...
    - 🎉 [slughorn](https://github.com/AlphaPixel/slughorn) - Library for shoehorning the _Slug_ text/graphics GPU rendering library into projects.
- C++: File Formats
...
- C++: Game Engine w/Editor
    ...
    - 🎉 [Doriax](https://github.com/doriaxengine/doriax) - Cross-platform for 2D/3D projects. Formerly _Supernova_.
    - 🎉 [Drop Creator](https://github.com/scidian/drop) - No code, 2.5D game engine built with _Qt_, OpenGL and _Chipmunk Physics_.
    - 🎉 [Echo](https://github.com/timi-liuliang/echo) - Cross-platform 2D/3D game engine.
    ...
    - 🎉 [Lumix Engine](https://github.com/nem0/LumixEngine) - 3D game engine with _Dear ImGui_ based editor.
...
- C++: Game Framework
    ...
    - 💸 [Valve Source SDK](https://github.com/ValveSoftware/source-sdk-2013) - The 2013 edition of the Source SDK by _[Valve Software](https://www.valvesoftware.com/)_. [[Info](https://en.wikipedia.org/wiki/Source_(game_engine)) | [Wiki](https://developer.valvesoftware.com/wiki/Source_SDK_2013)]
- C++: Geometry
...
- C++: Graphics - 3D
    ...
    - 🎉 [Dawn](https://dawn.googlesource.com/dawn) - Underlying engine that powers WebGPU in _Chromium_. [[GitHub](https://github.com/google/dawn)]
    ...
    - 🎉 [trinity](https://github.com/carbonengine/trinity) - Rendering engine for the _Carbon Game Engine_.
...
- C++: Physics
    ...
    - 🎉 [Box3D](https://github.com/erincatto/box3d) - 3D physics engine for games by the maker of _Box2D_.
...
### C#
- 📚 [Awesome C-Sharp](https://github.com/uhub/awesome-c-sharp) - List of awesome C-Sharp frameworks, libraries and software.
...
- Dart: Game Framework
    - 🎉 [Flame](https://github.com/flame-engine/flame) - Minimalist _Flutter_ based 2D game engine. [[Awesome](https://github.com/flame-engine/awesome-flame) | [Examples](https://examples.flame-engine.org/) | [Website](https://flame-engine.org/)]
...
### Haxe
- 📚 [Awesome Haxe](https://github.com/nadako/awesome-haxe) - Awesome curated list of useful Haxe links.
- 📚 [Awesome Haxe Game Dev](https://github.com/Dvergar/awesome-haxe-gamedev) - Awesome list of game dev resources for Haxe.
...
- Java: Game Engine w/Editor
    - 🎉 [Alice 3](https://github.com/TheAliceProject/alice3) - Block-based 3D engine to teach programming and animation, by _Carnegie Mellon_.
- Java: Game Framework
    - 🎉 [jMonkeyEngine](https://github.com/jMonkeyEngine/jmonkeyengine) - Modern 3D game development suite.
    - 🎉 [libGDX](https://github.com/libgdx/libgdx) - Game framework built on, and adds to _LWJGL_. [[Awesome](https://github.com/rafaskb/awesome-libgdx) | [Website](https://libgdx.com/)]
...
### JavaScript
- 📚 [Awesome JavaScript](https://github.com/sorrycc/awesome-javascript) - Collection of browser-side JavaScript libraries and resources.
...
- JavaScript: Game Engine w/Editor
    ...
    - 🎉 [GDevelop](https://github.com/4ian/GDevelop) - Full-featured 2D/3D/multiplayer game development. [[Website](https://gdevelop.io/)]
    ...
    - 🔒 [Infinite Reality Engine](https://github.com/ir-engine/ir-engine) - 3D toolkit for the social spatial web. Formerly _Ethereal Engine_.
...
- JavaScript: Graphics - 2D
    ...
    - 🎉 [PuzzleScript](https://github.com/increpare/puzzlescript) - Puzzle game engine, by the maker of _bfxr_. [[Awesome](https://github.com/lee2sman/awesome-puzzlescript)]
...
- JavaScript: Graphics - Three.js - Addon
    ...
    - 🎉 [three-nebula](https://github.com/creativelifeform/three-nebula) - WebGL particle system for Three.js.
...
- JavaScript: Gui
    ...
    - 🎉 [Magic Circle](https://github.com/dpwoert/magic-circle) - Multi-functional gui. Inspired by _dat.GUI_, _Unity_ and _Framer_.
...
- JavaScript: Visual Programming / Nodes
    ...
    - 🎉 [Litegraph.js](https://github.com/jagenjo/litegraph.js) - Create graphs in the browser similar to _Unreal Blueprints_. [[Demo](https://tamats.com/projects/litegraph/editor/)]
...
- Rust: Docking
    - 🎉 [egui_dock](https://github.com/anhosh/egui_dock) - Docking support for _egui_.
    - 🎉 [egui_tiles](https://github.com/rerun-io/egui_tiles) - Tiling layout engine for _egui_.
- Rust: Game Engine w/Editor
    ...
    - 🎉 [Renzora Engine](https://github.com/renzora/engine) - 3D game engine and visual editor built on _Bevy_.
- Rust: Game Framework
...
- Rust: Graphics - 3D
    ...
    - 🎉 [three-d](https://github.com/asny/three-d) - 2D/3D renderer, makes it simple to draw stuff across platforms.
    - 🎉 [Vulkano](https://github.com/vulkano-rs/vulkano) - Safe and rich wrapper around the Vulkan API.
    - 🎉 [wgpu](https://github.com/gfx-rs/wgpu) - Cross-platform graphics API, powers WebGPU in _Firefox_.
- Rust: Gui
...
### Swift
- 📚 [Awesome Swift](https://github.com/matteocrippa/awesome-swift) - Collaborative list of awesome Swift libraries and resources.
...
- Swift: Game Engine w/Editor
    - 🔒 [UntoldEngine](https://github.com/untoldengine/UntoldEngine) - For high-performance spatial visualization apps.
...
### Awesome Collections
- 📚 [Open Source Games](https://github.com/michelpereira/awesome-open-source-games) - Collection of games that have the source code available on _GitHub_.
...
- 🔒 [Wolfenstein 3D](https://github.com/id-Software/wolf3d) - The original open source release of _Wolfenstein 3D_.

### C++
- 🔒 [Doom 3](https://github.com/id-Software/DOOM-3) - _Doom 3_ GPL source release.
...
- 🔒 [NetHack](https://github.com/NetHack/NetHack) - Official _NetHack_ git repository.
- 🎉 [OpenLara](https://github.com/XProger/OpenLara) - Classic _Tomb Raider_ open source engine. [[Play](http://xproger.info/projects/OpenLara/)]
...
- 🔒 [Fluids-2D](https://github.com/mharrys/fluids-2d) - Real-time fluid dynamics on the GPU with the help of WebGL and Three.js.
...
- 🎉 [CrossShader](https://github.com/alaingalvan/CrossShader) - Cross-compiling shaders between GLSL, HLSL, Metal, and more.
...
- 📚 [Ronja Tutorials](https://github.com/ronja-tutorials/ShaderTutorials) - Tutorials covering many shader techniques.
...
- Postprocessing
    - 📚 [Image Editor Effects](https://github.com/alaingalvan/image-editor-effects) - WebGL image filters / effects shaders.
- Upscaling
...
- Sound Effects
    - 🆓 [Bfxr](https://www.bfxr.net) - Classic. For making simple sound effects for games. [[Source](https://github.com/increpare/bfxr2)]
...
- 🎉 [Palette Extractor](https://pixelpixi.github.io/spritewright/palette-extractor/) - Extract the palette from any sprite or image, export to GPL, ASE or hex. [[Source](https://github.com/pixelpixi/spritewright)]
...
- 🆓 [ArmorPaint](https://armorpaint.org) - Physically-based texture painting, drop in your 3D models and paint. [[Source](https://github.com/armory3d/armortools)]
...
- 🎉 [Pixelorama](https://github.com/Orama-Interactive/Pixelorama) - Open source pixel art multitool. [[Web Version](https://orama-interactive.itch.io/pixelorama)]
...
### Tilemap Editors
- 🎉 [Ogmo Editor](https://github.com/Ogmo-Editor-3/OgmoEditor3-CE) - Free, open source, project oriented tile map editor.
